...
public class Vista extends javax.swing.JFrame {
    ...
    public void presionar(int casilla) {
        if (lbs[casilla - 1].getText().equalsIgnoreCase("")) {
    ...
    public void comprobarganador() {
        for (int i = 0; i < vics.length; i++) {
            if (lbs[vics[i][0] - 1].getText().equalsIgnoreCase("X")
                    && lbs[vics[i][1] - 1].getText().equalsIgnoreCase("X")
                    && lbs[vics[i][2] - 1].getText().equalsIgnoreCase("X")) {

                
                lbs[vics[i][0] - 1].setBackground(Color.green);
                lbs[vics[i][1] - 1].setBackground(Color.green);
                lbs[vics[i][2] - 1].setBackground(Color.green);
                System.out.println("gano X");
            }
            if (lbs[vics[i][0] - 1].getText().equalsIgnoreCase("O")
                    && lbs[vics[i][1] - 1].getText().equalsIgnoreCase("O")
                    && lbs[vics[i][2] - 1].getText().equalsIgnoreCase("O")) {
